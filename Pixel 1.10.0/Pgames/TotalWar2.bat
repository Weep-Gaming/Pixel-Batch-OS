...
echo Welcome %name%!
echo.
set /p country=Choose your country; USA, Russia, lanceypoo, spotie, or Canada:
if '%country%'=='usa' goto enemy1
if '%country%'=='USA' goto enemy1
if '%country%'=='Usa' goto enemy1
if '%country%'=='lanceypoo' goto enemy4
if '%country%'=='spotie' goto enemy5
...
set country=Canada
:enemy4
set country=LanceypooRepublic
:enemy5
set country=SpotiepooRepublic
:enemy
...
echo 2. Fire Airstrike x %cpuairstrike%
echo.
echo 3. Fire Flake Missiles x %cpumissiles%
echo.
echo 4. Surrender
echo.
echo 5. Do nothing
...
echo Welcome %p1name%!
echo.
set /p p1country=Choose your country; USA, Russia, lanceypoo, spotie, or Canada:
...
if '%p1country%'=='Canada' goto p1country3
if '%p1country%'=='spotie' goto p1country4
if '%p1country%'=='lanceypoo' goto p1country5
goto p1country
:p1country1
set p1country=USA
goto p2country
...
goto p2country
:p1country4
set p1country=SpotiepooRepublic
goto p2country
:p1country5
set p1country=LanceypooRepublic
goto p2country
:p2country
cls
set p2country=
...
echo Welcome %p2name%!
echo.
set /p p2country=Choose your country; USA, Russia, lanceypoo, spotie, or Canada:
...
if '%p2country%'=='Canada' goto p2country3
if '%p2country%'=='spotie' goto p2country4
if '%p2country%'=='lanceypoo' goto p2country5
goto p2country
:na
cls
echo.
...
goto begin2
:p2country4
set p2country=SpotiepooRepublic
goto begin2
:p2country5
set p2country=LanceyPooRepublic
goto begin2
...
echo.
echo 3. Fire Melwom Missiles x %p1missiles%
echo.
echo 4. Surrender
echo.
echo 5. Do nothing
